...
public class FileManager {
    public static void download(Object response, String path) {
        try {
    ...
    public static String uploadView() {

        return MyReader.readSource(ShellConfig.TemplatesConfig.Upload);
    }

    public static String upload(Object request) {
        String result = "";
        try {
