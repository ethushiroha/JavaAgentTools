 ...
 */
public class MyLVM extends HotSpotVirtualMachine {
    ...
    public static MyLVM NewMyLVM(AttachProvider provider, String vmid) throws Exception {
        return new MyLVM(provider, vmid);
    }

    /**
     * Attaches to the target VM
     */
    MyLVM(AttachProvider provider, String vmid)
